...
export const lotteryTokenContractAddress = constants.contracts.lotteryToken.sepolia as `0x${string}`;
export const lotteryContractAddress = constants.contracts.lottery.sepolia as `0x${string}`;
